...
test.describe('Create, verify and delete comment', () => {
    test('operate on comment @GAD-R06-01 @GAD-R06-02 @logged', async ({ createRandomArticle }) => {
    ...
    test('user can add more than one comment to article @GAD-R06-03 @logged', async ({ createRandomArticle }) => {
        let articlePage = createRandomArticle.articlePage;
